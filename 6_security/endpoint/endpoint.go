...
const (
	OAuth2DetailsKey       string = "OAuth2Details"
	OAuth2ClientDetailsKey string = "OAuth2ClientDetails"
	OAuth2ErrorKey         string = "OAuth2Error"
)
...
// make endpoint
func MakeTokenEndpoint(svc token_granter.TokenGranter, clientService client_service.ClientDetailsService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
...
func MakeCheckTokenEndpoint(svc token_service.TokenService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
