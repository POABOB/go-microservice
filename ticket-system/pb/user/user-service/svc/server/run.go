...
import (
	...
	"github.com/POABOB/go-microservice/ticket-system/pb/user/user-service/handlers"
...
func NewEndpoints(service pb.UserServer) svc.Endpoints {
	// Business domain.
	...
	var (
		...
		loginwithgoogleEndpoint         = svc.MakeLoginWithGoogleEndpoint(service)
		loginwithgooglecallbackEndpoint = svc.MakeLoginWithGoogleCallbackEndpoint(service)
